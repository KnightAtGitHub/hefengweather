...
/**
 * Created by knight on 17-6-17.
 */

public class BaiduLocationTest extends AppCompatActivity{
    public LocationClient locationClient = null;
    public BDLocationListener myListener = new MyLocationListener();
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_baidu_location_test);
        locationClient = new LocationClient(MyApplication.getContext());
        locationClient.registerLocationListener(myListener);
        List<String> permissionList = new ArrayList<>();
        if (ContextCompat.checkSelfPermission(BaiduLocationTest.this,
        ...
        if (!permissionList.isEmpty()) {
            ...
            ActivityCompat.requestPermissions(BaiduLocationTest.this, permissions, 1);
        } else {
            requestLocation();
        }
